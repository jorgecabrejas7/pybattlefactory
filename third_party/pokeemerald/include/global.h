...
struct GEN3_APCS Coords8
{
    s8 x;
    s8 y;
};

struct GEN3_APCS UCoords8
{
    u8 x;
    u8 y;
};

struct GEN3_APCS Coords16
{
    s16 x;
    s16 y;
};

struct GEN3_APCS UCoords16
{
    u16 x;
    u16 y;
};

struct GEN3_APCS Coords32
{
    s32 x;
    s32 y;
};

struct GEN3_APCS UCoords32
{
    u32 x;
    u32 y;
};

struct GEN3_APCS Time
{
    /*0x00*/ s16 days;
    /*0x02*/ s8 hours;
    /*0x03*/ s8 minutes;
...
struct GEN3_APCS PokemonJumpRecords
{
    u16 jumpsInRow;
...
struct GEN3_APCS BerryPickingResults
{
    u32 bestScore;
    u16 berriesPicked;
...
struct GEN3_APCS ApprenticeMon
{
    u16 species;
...
struct GEN3_APCS BattleTowerPokemon
{
    u16 species;
    u16 heldItem;
    u16 moves[MAX_MON_MOVES];
...
struct GEN3_APCS EmeraldBattleTowerRecord
{
...
struct GEN3_APCS BattleTowerInterview
{
    u16 playerSpecies;
    u16 opponentSpecies;
...
struct GEN3_APCS BattleTowerEReaderTrainer
{
    /*0x00*/ u8 unk0;
    /*0x01*/ u8 facilityClass;
    /*0x02*/ u16 winStreak;
...
struct GEN3_APCS BattleDomeTrainer
{
    u16 trainerId:10;
    u16 isEliminated:1;
    u16 eliminatedAt:2;
...
struct GEN3_APCS BattleFrontier
{
...
struct GEN3_APCS ApprenticeQuestion
{
    u8 questionId:2;
    u8 monId:2;
    u8 moveSlot:2;
...
struct GEN3_APCS PlayersApprentice
{
    /*0xB0*/ u8 id;
...
struct GEN3_APCS RankingHall1P
{
...
struct GEN3_APCS RankingHall2P
{
...
struct GEN3_APCS SecretBaseParty
{
...
struct GEN3_APCS ItemSlot
{
    u16 itemId;
    u16 quantity;
};

struct GEN3_APCS Pokeblock
{
    u8 color;
    u8 spicy;
    u8 dry;
...
struct GEN3_APCS RamScriptData
{
    u8 magic;
    u8 mapGroup;
    u8 mapNum;
...
struct GEN3_APCS MauvilleManCommon
{
    u8 id;
};

struct GEN3_APCS MauvilleManBard
{
    /*0x00*/ u8 id;
    /*0x01*/ //u8 padding1;
...
struct GEN3_APCS MauvilleManStoryteller
{
    u8 id;
...
struct GEN3_APCS MauvilleManGiddy
{
    /*0x00*/ u8 id;
    /*0x01*/ u8 taleCounter;
    /*0x02*/ u8 questionNum;
...
struct GEN3_APCS MauvilleManHipster
{
    u8 id;
    bool8 taughtWord;
    u8 language;
...
struct GEN3_APCS MauvilleOldManTrader
{
    u8 id;
...
typedef union GEN3_APCS OldMan
{
...
struct GEN3_APCS LinkBattleRecord
{
    u8 name[PLAYER_NAME_LENGTH + 1];
    u16 trainerId;
    u16 wins;
...
struct GEN3_APCS LinkBattleRecords
{
...
struct GEN3_APCS RecordMixingGiftData
{
    u8 unk0;
    u8 quantity;
    u16 itemId;
...
struct GEN3_APCS RecordMixingGift
{
    int checksum;
    struct RecordMixingGiftData data;
};

struct GEN3_APCS ContestWinner
{
    u32 personality;
    u32 trainerId;
    u16 species;
...
struct GEN3_APCS LilycoveLadyQuiz
{
    /*0x000*/ u8 id;
    /*0x001*/ u8 state;
...
struct GEN3_APCS LilycoveLadyFavor
{
    /*0x000*/ u8 id;
    /*0x001*/ u8 state;
...
struct GEN3_APCS LilycoveLadyContest
{
    /*0x000*/ u8 id;
...
struct GEN3_APCS TrainerNameRecord
{
    u32 trainerId;
    u8 ALIGNED(2) trainerName[PLAYER_NAME_LENGTH + 1];
};

struct GEN3_APCS TrainerHillSave
{
    /*0x3D64*/ u32 timer;
    /*0x3D68*/ u32 bestTime;
    /*0x3D6C*/ u8 unk_3D6C;
...
struct GEN3_APCS WonderNewsMetadata
{
    u8 newsType:2;
...
struct GEN3_APCS WonderCardMetadata
{
    u16 battlesWon;
    u16 battlesLost;
    u16 numTrades;
...
struct GEN3_APCS MysteryGiftSave
{
    u32 newsCrc;
