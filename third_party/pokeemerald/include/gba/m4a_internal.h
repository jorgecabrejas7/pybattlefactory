...
struct GEN3_APCS PokemonCrySong
{
    u8 trackCount;
    u8 blockCount;
    u8 priority;
...
struct GEN3_APCS MusicPlayerTrack
{
    u8 flags;
    u8 wait;
    u8 patternLevel;
...
struct GEN3_APCS MusicPlayerInfo
{
