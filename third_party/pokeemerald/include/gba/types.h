...
struct GEN3_APCS BgAffineSrcData
{
    s32 texX;
    s32 texY;
    s16 scrX;
...
struct GEN3_APCS BgAffineDstData
{
    s16 pa;
    s16 pb;
    s16 pc;
...
struct GEN3_APCS ObjAffineSrcData
{
    s16 xScale;
    s16 yScale;
    u16 rotation;
