...
struct GEN3_APCS TextPrinterSubStruct
{
    u8 fontId:4;  // 0x14
...
struct GEN3_APCS TextPrinterTemplate
{
...
struct GEN3_APCS GlyphWidthFunc
{
    u32 fontId;
    u32 (*func)(u16 glyphId, bool32 isJapanese);
};

typedef struct GEN3_APCS {
