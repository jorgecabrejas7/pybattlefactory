...
struct GEN3_APCS ListMenuItem
{
    const u8 *name;
    s32 id;
};

struct GEN3_APCS ListMenuTemplate
{
...
struct GEN3_APCS ListMenuWindowRect
{
    u8 x;
    u8 y;
    u8 width;
...
struct GEN3_APCS ScrollArrowsTemplate
{
    u8 firstArrowType;
    u8 firstX;
    u8 firstY;
