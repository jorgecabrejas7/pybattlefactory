...
struct GEN3_APCS ResourceFlags
{
...
struct GEN3_APCS DisableStruct
{
...
struct GEN3_APCS ProtectStruct
{
    u32 protected:1;
    u32 endured:1;
    u32 noValidMoves:1;
...
struct GEN3_APCS SpecialStatus
{
    u32 statLowered:1;
...
struct GEN3_APCS WishFutureKnock
{
...
struct GEN3_APCS AI_ThinkingStruct
{
    u8 aiState;
    u8 movesetIndex;
    u16 moveConsidered;
...
struct GEN3_APCS UsedMoves
{
    u16 moves[MAX_MON_MOVES];
    u16 unknown[MAX_MON_MOVES];
};

struct GEN3_APCS BattleHistory
{
...
struct GEN3_APCS BattleScriptsStack
{
    const u8 *ptr[8];
    u8 size;
};

struct GEN3_APCS BattleCallbacksStack
{
    void (*function[8])(void);
    u8 size;
};

struct GEN3_APCS StatsArray
{
    u16 stats[NUM_STATS];
};

struct GEN3_APCS BattleResources
{
...
struct GEN3_APCS BattleResults
{
...
struct GEN3_APCS BattleTv_Side
{
    u32 spikesMonId:3;
    u32 reflectMonId:3;
...
struct GEN3_APCS BattleTv_Position
{
    u32 curseMonId:3;
...
struct GEN3_APCS BattleTvMovePoints
{
    s16 points[2][PARTY_SIZE * 4];
};

struct GEN3_APCS LinkBattlerHeader
{
...
struct GEN3_APCS BattleScripting
{
    s32 painSplitHp;
    s32 bideDmg;
    u8 multihitString[6];
...
struct GEN3_APCS BattleSpriteInfo
{
    u16 invisible:1; // 0x1
    u16 lowHpSong:1; // 0x2
...
struct GEN3_APCS BattleAnimationInfo
{
...
struct GEN3_APCS BattleHealthboxInfo
{
...
struct GEN3_APCS BattleBarInfo
{
...
struct GEN3_APCS BattleSpriteData
{
...
struct GEN3_APCS MonSpritesGfx
{
