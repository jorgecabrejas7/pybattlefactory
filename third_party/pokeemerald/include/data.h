...
struct GEN3_APCS TrainerMonNoItemDefaultMoves
{
    u16 iv;
    u8 lvl;
    u16 species;
...
struct GEN3_APCS TrainerMonItemDefaultMoves
{
    u16 iv;
    u8 lvl;
    u16 species;
...
struct GEN3_APCS TrainerMonNoItemCustomMoves
{
    u16 iv;
    u8 lvl;
    u16 species;
...
struct GEN3_APCS TrainerMonItemCustomMoves
{
    u16 iv;
    u8 lvl;
    u16 species;
