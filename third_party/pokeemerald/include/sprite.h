...
struct GEN3_APCS CompressedSpriteSheet
{
...
struct GEN3_APCS SpriteFrameImage
{
    const void *data;
    u16 size;
};
...
struct GEN3_APCS SpritePalette
{
    const u16 *data;  // Raw uncompressed palette data
    u16 tag;
};

struct GEN3_APCS CompressedSpritePalette
{
    const u32 *data;  // LZ77 compressed palette data
    u16 tag;
};

struct GEN3_APCS AnimFrameCmd
{
...
struct GEN3_APCS AnimLoopCmd
{
    u32 type:16;
    u32 count:6;
};

struct GEN3_APCS AnimJumpCmd
{
    u32 type:16;
    u32 target:6;
};
...
struct GEN3_APCS AffineAnimFrameCmd
{
    s16 xScale;
    s16 yScale;
    u8 rotation;
...
struct GEN3_APCS AffineAnimLoopCmd
{
    s16 type;
    s16 count;
};

struct GEN3_APCS AffineAnimJumpCmd
{
    s16 type;
    u16 target;
};

struct GEN3_APCS AffineAnimEndCmdAlt
{
    s16 type;
    u16 val;
};

union GEN3_APCS AffineAnimCmd
{
    s16 type;
...
struct GEN3_APCS AffineAnimState
{
    u8 animNum;
    u8 animCmdIndex;
    u8 delayCounter;
...
struct GEN3_APCS SubspriteTable
{
    u8 subspriteCount;
...
struct GEN3_APCS SpriteTemplate
{
    u16 tileTag;
    u16 paletteTag;
