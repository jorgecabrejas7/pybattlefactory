...
struct GEN3_APCS PulseBlendSettings
{
    u16 blendColor;
    u16 paletteOffset;
    u8 numColors;
...
struct GEN3_APCS PulseBlendPalette
{
    u8 paletteSelector;
    u8 blendCoeff:4;
    u8 fadeDirection:1;
...
struct GEN3_APCS RouletteFlashSettings
{
    u16 color;
    u16 paletteOffset;
    u8 numColors;
...
struct GEN3_APCS RouletteFlashPalette
{
    u8 state:7;
    bool8 available:1;
    u8 delayCounter;
...
struct GEN3_APCS RouletteFlashUtil
{
    u8 enabled;
    u8 unused;
    u16 flags;
