...
struct GEN3_APCS PokenavMonListItem
{
    u8 boxId;
    u8 monId;
    u16 data;
...
struct GEN3_APCS PokenavMatchCallEntry
{
...
struct GEN3_APCS PokenavListItem
{
    union GEN3_APCS {
...
struct GEN3_APCS PokenavListTemplate
{
...
struct GEN3_APCS PokenavMonList
{
    u16 listCount;
    u16 currIndex;
