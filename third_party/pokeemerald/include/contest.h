...
struct GEN3_APCS ContestPokemon
{
    u16 species;
...
struct GEN3_APCS ContestTempSave
{
...
struct GEN3_APCS ContestMoveAnimData
{
    u16 species;
    u16 targetSpecies;
...
struct GEN3_APCS ContestantStatus
{
    s16 baseAppeal;
    s16 appeal;
    s16 pointTotal;
...
struct GEN3_APCS ContestAppealMoveResults
{
...
struct GEN3_APCS ContestAIInfo
{
    /*0x00*/ u8 aiState;
    /*0x02*/ u16 nextMove;
...
struct GEN3_APCS ContestExcitement
{
    s8 moveExcitement;
    u8 frozen:1;
    u8 freezer:3;
...
struct GEN3_APCS ContestGraphicsState
{
...
struct GEN3_APCS ContestFinalStandings
{
    s32 totalPoints;
    s32 round1Points;
    s32 random;
...
struct GEN3_APCS ContestUnused
{
    u8 filler[12];
};

struct GEN3_APCS ContestResources
{
