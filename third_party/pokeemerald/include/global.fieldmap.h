...
struct GEN3_APCS BackupMapLayout
{
    s32 width;
    s32 height;
    u16 *map;
...
struct GEN3_APCS ObjectEventTemplate
{
    /*0x00*/ u8 localId;
    /*0x01*/ u8 graphicsId;
...
struct GEN3_APCS MapConnection
{
    u8 direction;
    s32 offset;
    u8 mapGroup;
...
struct GEN3_APCS MapConnections
{
    s32 count;
    const struct MapConnection *connections;
};

struct GEN3_APCS MapHeader
{
...
struct GEN3_APCS ObjectEventGraphicsInfo
{
    /*0x00*/ u16 tileTag;
    /*0x02*/ u16 paletteTag;
