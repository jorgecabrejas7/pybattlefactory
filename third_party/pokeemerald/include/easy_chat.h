...
struct GEN3_APCS EasyChatScreenTemplate
{
    u8 type;
    u8 numColumns;
    u8 numRows;
...
struct GEN3_APCS EasyChatScreen
{
    /*0x00*/ u8 type;
    /*0x01*/ u8 templateId;
    /*0x02*/ u8 numColumns;
...
struct GEN3_APCS EasyChatScreenControl
{
    u16 funcState;
    u16 windowId;
    u16 currentFuncId;
...
struct GEN3_APCS EasyChatPhraseFrameDimensions
{
    u8 left:5;
    u8 top:3;
    u8 width;
...
struct GEN3_APCS EasyChatWordInfo
{
    const u8 *text;
...
struct GEN3_APCS EasyChatScreenWordData
{
...
struct GEN3_APCS EasyChatWordsByLetter
{
    const u16 *words;
    int numWords;
};
