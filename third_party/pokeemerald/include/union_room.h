...
struct GEN3_APCS RfuPlayerList
{
    struct RfuPlayer players[MAX_RFU_PLAYER_LIST_SIZE];
};

struct GEN3_APCS RfuIncomingPlayer
{
    struct RfuPlayerData rfu;
    bool8 active:1;
};

struct GEN3_APCS RfuIncomingPlayerList
{
    struct RfuIncomingPlayer players[MAX_RFU_PLAYERS];
};

struct GEN3_APCS WirelessLink_Leader
{
...
struct GEN3_APCS WirelessLink_Group
{
    struct RfuPlayerList *playerList;
    struct RfuIncomingPlayerList *incomingPlayerList;
    u8 state;
...
struct GEN3_APCS UnionRoomObject
{
    u8 state;
    u8 gfxId;
    s8 animState;
...
struct GEN3_APCS WirelessLink_URoom
{
    struct RfuPlayerList *playerList;
...
struct GEN3_APCS UnionRoomTrade
{
    u16 state;
    u16 type;
