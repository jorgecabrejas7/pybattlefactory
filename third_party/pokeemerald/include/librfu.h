...
struct GEN3_APCS RfuPacket8
{
    u8 data[0x74];
};

struct GEN3_APCS RfuPacket32
{
    u32 command;
    u32 data[0x1C];
};

union GEN3_APCS RfuPacket
{
    struct RfuPacket32 rfuPacket32;
    struct RfuPacket8 rfuPacket8;
};

struct GEN3_APCS STWIStatus
{
    vs32 state;
    u8 reqLength;
    u8 reqNext;
...
struct GEN3_APCS RfuIntrStruct
{
...
struct GEN3_APCS RfuSlotStatusUNI
{
...
struct GEN3_APCS RfuSlotStatusNI
{
...
struct GEN3_APCS RfuLinkStatus
{
