...
struct GEN3_APCS PokemonSubstruct0
{
    u16 species;
    u16 heldItem;
    u32 experience;
...
struct GEN3_APCS PokemonSubstruct1
{
    u16 moves[MAX_MON_MOVES];
    u8 pp[MAX_MON_MOVES];
};

struct GEN3_APCS PokemonSubstruct2
{
    u8 hpEV;
    u8 attackEV;
    u8 defenseEV;
...
struct GEN3_APCS PokemonSubstruct3
{
 /* 0x00 */ u8 pokerus;
...
union GEN3_APCS PokemonSubstruct
{
...
struct GEN3_APCS MonSpritesGfxManager
{
    u32 numSprites:4;
...
struct GEN3_APCS BattlePokemon
{
    /*0x00*/ u16 species;
    /*0x02*/ u16 attack;
    /*0x04*/ u16 defense;
